...
<template>
  <ProgressItem
    :title="p1.title"
    :order-i-d="p1.orderID"
    :image="p1.image"
    :is-disabled="p1.isDisabled"
  />
  <ProgressItem
    :title="p2.title"
    :order-i-d="p2.orderID"
    :image="p2.image"
    :is-disabled="p2.isDisabled"
  />
  <ProgressItem
    :title="p3.title"
    :order-i-d="p3.orderID"
    :image="p3.image"
    :is-disabled="p3.isDisabled"
  />
  <ProgressItem
    :title="p4.title"
    :order-i-d="p4.orderID"
    :image="p4.image"
    :is-disabled="p4.isDisabled"
  />
  <ProgressItem
    :title="p5.title"
    :order-i-d="p5.orderID"
    :image="p5.image"
    :is-disabled="p5.isDisabled"
  />
</template>
